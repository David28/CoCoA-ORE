...
function data_query_build( $params = array( ) ){
	...
	$sensor = is_numeric( $params['sensor'] ) ? $params['sensor'] : echo 'no sensor error: '.$params['sensor'];	
...
function sensor_add( $params = array() ){
	...
	$qq = "INSERT INTO measure_sensors ( sensor_id, sensor_title ) VALUES ( '$params[sensor_id]', '$params[sensor_name]' )";
	$db->query($qq);
